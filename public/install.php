...
function install($username, $password, $config, $adminUrl)
{
    ...
    $sqlArray = parseSql($config['prefix'], 'ea_',$sqlPath);
    Db::startTrans();
    try {
    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="database" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据库名称" placeholder="请输入数据库名称" value="peizi">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="prefix" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据表前缀" placeholder="请输入数据表前缀" value="pz_">
                </div>
            </div>
